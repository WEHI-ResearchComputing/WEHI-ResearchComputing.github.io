...
[There is a video available](https://urldefense.com/v3/__https://wehieduau-my.sharepoint.com/:v:/g/personal/mosbergen_r_wehi_edu_au/EU4fENR4KJpKjzOgDFbUNYUB5DmcmH3xaSp2CjZ2k2OerQ?nav=eyJyZWZlcnJhbEluZm8iOnsicmVmZXJyYWxBcHAiOiJTdHJlYW1XZWJBcHAiLCJyZWZlcnJhbFZpZXciOiJTaGFyZURpYWxvZy1MaW5rIiwicmVmZXJyYWxBcHBQbGF0Zm9ybSI6IldlYiIsInJlZmVycmFsTW9kZSI6InZpZXcifX0*3D&e=d7zTvX&referrer=Outlook.Web&referrerScenario=email-linkwithembed__;JQ!!KKt0acMt!d2xyJaPfzT88bitGs_dByZOw-f0sjqQglJ2vbvtIOS5S7RAQWsjUWFnclLCJCJISORvlkgvpvNMBy1bY7y2r_xlZ5700mvOhckQ$) at Onboarding todo channel > Files > 2021-12-22 Data science internship survey questions. 
...
2. Please send a weekly email update one business day before the meeting (ie. Friday if you have a Monday meeting) with the subject '[Project name] week [x] update' eg. 'Clinical Dashboards week 3 update'. The email should have:
    ...
    3. provide links to each interns [Individual Learning Plan](https://doi.org/10.6084/m9.figshare.29577977.v1)
    4. provide links to the previous final presentations by previous students,
    5. provide a link to the whiteboard session video or image you did (after week 4), 
    6. provide a summary of the top things you discussed in the whiteboard session (after week 4),
    7. provide a link to the wiki and/or the GitHub repository, 
    8. provide a link to the technical notes in WEHI-wide student intern group in Sharepoint / Files in Teams
    9. remember to ask to record the meeting to more easily keep notes if needed,
    10. and provide bullet point summary from previous meeting.
